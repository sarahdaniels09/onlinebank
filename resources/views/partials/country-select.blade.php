{{-- 
    Country Select Partial
    Usage: @include('partials.country-select', ['fieldName' => 'country', 'required' => true])
    
    Parameters:
    - fieldName: The name attribute for the select element (default: 'country')
